...
wget https://zenodo.org/api/records/7882613/files-archive
...
wget https://zenodo.org/api/records/7830345/files-archive
...
wget https://zenodo.org/api/records/7860847/files-archive
...
git clone "https://github.com/nttcslab/dcase2023_task2_evaluator"
mv dcase2023_task2_evaluator ../eval_data/dcase2023_evaluator
